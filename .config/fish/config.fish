...
set fish_prompt_user $USER #(bash_yq .str.user $fish_prompt_cfgf || echo $USER)
set fish_prompt_host $hostname #(bash_yq .str.host $fish_prompt_cfgf || echo $hostname)
set fish_prompt_rdircolor true # (bash_yq .rdircolor $fish_prompt_cfgf || echo true)
